...
class TestSchemeService:
    ...
    def test_find_schemes_returns_response_with_query(self) -> None:
    ...
    def test_find_schemes_matches_insurance(self) -> None:
    ...
    def test_find_schemes_matches_credit(self) -> None:
    ...
    def test_find_schemes_matches_income_support(self) -> None:
    ...
    def test_find_schemes_falls_back_to_all_when_no_match(self) -> None:
    ...
    def test_score_scheme_counts_matching_tokens(self) -> None:
    ...
    def test_score_scheme_zero_for_no_match(self) -> None:
        """_score_scheme returns 0 when no tokens match."""
        service = SchemeService()
        pm_kisan = service._schemes[0]
        assert service._score_scheme(pm_kisan, ["spaceship", "rocket"]) == 0

    def test_more_relevant_scheme_ranked_first(self) -> None:
